...
class CircularCountDownTimerState extends State<CircularCountDownTimer> with TickerProviderStateMixin {
  ...
  String _getSec(Duration duration) {
  ...
  void initState() {
    super.initState();
    // _controller = widget.animateController;
    // init();
...
class CountDownController {
  ...
  void resume() {
    if (_isReverse) {
      _state._controller?.reverse(from: _state._controller.value = _state._controller.value);
    } else {
  ...
  void forward({int duration}) {
    // _state._controller.value = duration.toDouble() / _state._controller.duration.inSeconds;
    var newDuration = duration.toDouble() / _state._controller.duration.inSeconds;
    _state._controller?.reverse(from: _state._controller.value = _state._controller.value - newDuration);
  }

  status() {
   return _state._controller.isCompleted;
  }
  ...
  String getSec() {
    // return _state._controller.duration.inSeconds.toString();
    return _state._getSec(_state._controller.duration * _state._controller?.value);
  }
}
